...
const SAFE_STRING_VALUES = new Set([
  ...
  'jina', 'longform', 'mixed', 'negative', 'neutral', 'openai', 'pending',
...
const SAFE_LOG_KEYS = new Set([
  ...
  'candidate_tokens', 'category', 'chars', 'citations', 'claims', 'count',
  'delayMs', 'depth', 'dropped_claims', 'dropped_quotes', 'enabled', 'error',
  'errorClass', 'errors', 'estimated_sections', 'eventType', 'feedTitle',
  'feedUrl', 'gaps', 'group', 'hashtagCount', 'input_tokens', 'kind', 'method',
  'mode', 'model', 'operation', 'output_tokens', 'parentId', 'parsed', 'pass',
  'passed', 'phase', 'prompt_tokens', 'provider', 'providerName', 'query',
  'quotes', 'rawText', 'reason', 'recency_days', 'redacted', 'replies',
  'resultCount', 'results', 'retryable', 'returned', 'sections', 'sort', 'sorts',
  'source_mode', 'status', 'success', 'target', 'taskId', 'timeFilter', 'total',
  'upvotes', 'url', 'videoId', 'views', 'waitMs',
]);

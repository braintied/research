...
const DEFINITIONS: Record<AtomicSourceMode, SourceModeDefinition> = {
  web: {
    ...
    backendPolicy: [
      ...
      { backend: 'jina', role: 'fallback', priority: 2, state: 'implemented', note: 'JS/paywall-tolerant reader fallback.' },
      { backend: 'direct_fetch', role: 'fallback', priority: 3, state: 'implemented', note: 'Last-resort plain HTTP extraction.' },
    ],
  ...
  x: {
    ...
    backendPolicy: [
      ...
      { backend: 'apify', role: 'fallback', priority: 4, state: 'implemented', note: 'Last transport fallback after native/contracted X search fails.' },
    ],
  ...
  instagram: {
    ...
    description: 'Instagram hashtag/post/profile research through Bright Data.',
    ...
    backendPolicy: [
      { backend: 'brightdata', role: 'discovery', priority: 1, state: 'implemented', note: 'Strict fail-closed Instagram dataset path.' },
    ],
    minimumDiscoveries: 2, minimumUniqueSources: 2,
  },
  tiktok: {
    ...
    defaultSearchOptions: { sort: 'relevance', recency_days: 180, max_pages: 1 },
    backendPolicy: [
      { backend: 'brightdata', role: 'acquisition', priority: 1, state: 'implemented', note: 'Preferred URL fetch when available.' },
      { backend: 'apify', role: 'discovery', priority: 2, state: 'implemented', note: 'Keyword discovery and comment-rich fallback until Bright Data discovery is configured.' },
    ],
    minimumDiscoveries: 2, minimumUniqueSources: 2,
  },
  facebook_groups: {
    ...
    backendPolicy: [
      ...
      { backend: 'apify', role: 'fallback', priority: 2, state: 'implemented', note: 'Current keyword/group search fallback.' },
    ],
    minimumDiscoveries: 2, minimumUniqueSources: 2,
  },
  cortex: {
